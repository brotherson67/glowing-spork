...
function StravaActivities() {
  ...
  useEffect(() => {
    console.log(params)
    if (code) {
      function convertAuthToAccess() {
        const authLink = `https://www.strava.com/oauth/token?client_id=${client_id}&client_secret=${client_secret}&code=${code}&grant_type3=authorization_code
        `
